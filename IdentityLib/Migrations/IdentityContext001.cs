...
{
    /// <inheritdoc />
    public partial class IdentityContext001 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "TEXT", nullable: false),
                    ChatTelegramId = table.Column<long>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TelegramJoinActions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainTelegramMessageId = table.Column<int>(type: "INTEGER", nullable: true),
                    DialogTelegramTypeHandler = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUsers_ChatTelegramId",
                table: "ApplicationUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TelegramJoinActions_CreatedAt",
                table: "TelegramJoinActions",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_TelegramJoinActions_GuidToken",
                table: "TelegramJoinActions",
                column: "GuidToken");

            migrationBuilder.CreateIndex(
                name: "IX_TelegramJoinActions_UserIdentityId",
                table: "TelegramJoinActions",
                column: "UserIdentityId");

            migrationBuilder.CreateIndex(
                name: "IX_TelegramUsers_NormalizedFirstNameUpper",
                table: "TelegramUsers",
                column: "NormalizedFirstNameUpper");

            migrationBuilder.CreateIndex(
                name: "IX_TelegramUsers_NormalizedLastNameUpper",
                table: "TelegramUsers",
                column: "NormalizedLastNameUpper");

            migrationBuilder.CreateIndex(
                name: "IX_TelegramUsers_NormalizedUserNameUpper",
                table: "TelegramUsers",
