...
> [!NOTE]
> **constructor** (*на данный момент на этапе разработки*) - гибкое web решение для конструирования документов, справочников и т.п.. А так же генерация C# .net кода для созданной структуры сущностей со всеми её связями (целиком). Такое решение позволит с нуля сконструировать новое приложение со своей структурой БД и CRUD+ набором сервисов (+ web/ui of `BlazorWebApp`). Этот сгенерированный код легко ляжет на данную базовую заготовку или в любое другое приложение схожей структуры. 
