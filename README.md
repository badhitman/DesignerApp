...
### ToolsMauiApp
Клиент для управления службами удалённо: колхоз на тему ci/cd. На стоковом хостинге организовать CI/CD полного цикла не получается: 1-2 ядра и 1-2 GB ОЗУ не хватает для обслуживания таких потребностей. Локальный ПК сильно выигрывает по мощности и доставка файлов нужна не всегда вся (целиком). Данное решение позволяет синхронизировать папки с сервером (управлять этим процессом) и выполнять удалённые команды.
