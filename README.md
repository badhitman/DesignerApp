...
- .NET Aspire: [набор инструментов для оркестрации](https://github.com/badhitman/DesignerApp/tree/main/DesignerApp.AppHost): мониторинг сервисов (телеметрия, трассировка). ![aspire main](./img/aspire-main.png) ![aspire trace](./img/aspire-trace-mq.png)
