...
### ToolsMauiApp
[Утилита для удалённого взаимодействия с сервисами](https://github.com/badhitman/DesignerApp/tree/main/ToolsMauiApp):
- Колхоз на тему ci/cd: стоковый хостинг не в силах выдержать CI/CD полного цикла (1-2 ядра и 1-2 GB ОЗУ не хватает для сборки). Идея в том, что бы публиковать на рабочем ПК и доставить на сервер только те файлы, которые изменились/появились.
