...
public static class RegisterMqListenerExtension
{
    ...
    public static IServiceCollection CommerceRegisterMqListeners(this IServiceCollection services)
    {
        return services
            ...
            .RegisterMqListener<OffersRegistersSelectReceive, TPaginationRequestModel<RegistersSelectRequestBaseModel>, TResponseModel<TPaginationResponseModel<OfferAvailabilityModelDB>>>()
            .RegisterMqListener<WarehousesSelectReceive, TPaginationRequestModel<WarehouseDocumentsSelectRequestModel>, TResponseModel<TPaginationResponseModel<WarehouseDocumentModelDB>>>()
