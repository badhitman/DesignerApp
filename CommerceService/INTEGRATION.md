# План обмена
- Юридические лица создаются и редактируются на сайте, а внешняя ИС может [принимать или отклонять](#обновление-данных-по-контрагенту) новые компании или изменения в них.
