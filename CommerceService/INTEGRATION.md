## Авторизация
Для авторизации нужно каждый запрос снабжать заголовком 'token-access' с токеном доступа. Сейчас есть тестовый токен E1B4C4F4-69AA-4A83-BB79-E08728739A33. Пример запроса:
``` shell
