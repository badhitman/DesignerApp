...
namespace DbPostgreLib.Migrations.Helpdesk
{
    ...
    [Migration("20241012195721_HelpdeskPostgreContext003")]
    partial class HelpdeskPostgreContext003
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SharedLib.StorageArticleModelDB", b =>
                {
                    ...
                    b.Property<int?>("RubricArticleModelDBId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("RubricArticleModelDBId");
            ...
            modelBuilder.Entity("SharedLib.StorageArticleModelDB", b =>
                {
                    b.HasOne("SharedLib.RubricArticleModelDB", null)
                        .WithMany("Issues")
                        .HasForeignKey("RubricArticleModelDBId");
                });
