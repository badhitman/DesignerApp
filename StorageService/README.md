...
Система общих/разделяемых параметров. Благодаря ей можно хранить и читать параметры разным сервисам обращаясь к обще службе, которая автономно хранит все данные в своей БД. Хранить можно любые `сериализуемые` данные.

#### Файлы
Хранение файлов в MongoDB (MongoDB.Driver.GridFS).
