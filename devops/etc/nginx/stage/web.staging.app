server {
    listen 80;
    server_name stage.bmy-site.ru www.stage.my-site.ru;
...
server {
	listen 443 ssl;
	listen [::]:443 ssl;
	server_name stage.my-site.ru www.stage.my-site.ru;
	ssl_certificate /etc/ssl/my-site/my-site.crt;
	ssl_certificate_key /etc/ssl/my-site/my-site.key;
	large_client_header_buffers 4 128k;

	access_log /var/log/nginx/nginx.web.stage.my-site.ru.access.log;
	error_log /var/log/nginx/nginx.web.stage.my-site.ru.error.log;
