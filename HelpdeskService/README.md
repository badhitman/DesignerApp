...
Все участники (у которых привязан Telegram) доступны в своей области. Можно сразу вести переписку с клиентом напрямую от имени бота. Сюда попадают все пользователи, связанные с данным обращением: подписчики, автор, исполнитель.
